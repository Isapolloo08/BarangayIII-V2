...
const AddCensusData = ({ navigation, route }) => {
    ...
    const [householdHeadData, setHouseholdHeadData] = useState({
        householdNumber: '',
        lastName: '',
        firstName: '',
        middleName: '',
    ...
    const validateHouseholdHead = () => {
        const requiredFields = ['householdNumber', 'lastName', 'firstName', 'middleName', 'region', 'province', 'municipality', 'baranggay', 'purok', 'dateOfBirth', 'age', 'sex', 'civilStatus', 'psMember', 'medicalHistory', 'classificationByAgeHealth', 'typeOfWaterSource', 'typeOfToiletFacility'];
        const missingFields = requiredFields.filter(field => !householdHeadData[field]);

        if (missingFields.length > 0) {
            Alert.alert('Missing Information', `Please fill in the following fields for Household Head: ${missingFields.join(', ')}`);
            return false;
        }
        return true;
    };
    ...
    const validateHouseholdMembers = () => {
        for (let i = 0; i < householdMembers.length; i++) {
            ...
            const requiredFields = ['lastName', 'firstName', 'middleName' , 'dateOfBirth', 'sex', 'civilStatus', 'medicalHistory'];
            const missingFields = requiredFields.filter(field => !member[field]);

            if (missingFields.length > 0) {
                Alert.alert('Missing Information', `Please fill in the following fields for Household Member ${i + 1}: ${missingFields.join(', ')}`);
                return false;
            }
        }
        return true;
    ...
    // Function to update date of visit
    const onDateOfVisit = (event, selectedDate) => {
        const currentDate = selectedDate || dateOfVisit;
        setShowDatePicker(false);
        setDateOfVisit(currentDate);
    };

    // Get the current date and set as minimum date
    const minDate1 = new Date();
    const maxDate1 = new Date(2100, 11, 31);
        ...
        <KeyboardAwareScrollView style={styles.container} contentContainerStyle={styles.scrollContent}>
            <View style={styles.container}>
                <View style={styles.box}>
                    {currentPage === 1 && (
                        <>
                        <Text style={styles.title1}>HOUSEHOLD HEAD</Text>
                            <View style={styles.box1}>
                            <Text style={styles.title}>I. Personal Information</Text>
                            <View style={styles.inputContainer}>
                                <Text>Date of Visit: <Text style={styles.required}>*</Text> </Text>
                                <TouchableOpacity onPress={showDatePickerModal} style={styles.datePickerText}>
                                    <Text>{dateOfVisit.toLocaleDateString()}</Text>
                                    </TouchableOpacity>
                                    {showDatePicker && (
                                        <DateTimePicker
                                        value={dateOfVisit}
                                        mode="date"
                                        display="default"
                                        maximumDate={maxDate1}
                                        minimumDate={minDate1}
                                        onChange={onDateOfVisit}
                                    />
                                )}
                            </View>
                            <View style={styles.inputContainer}>
                    ...
                    {currentPage === 2 && (
                        <>
                        <Text style={styles.title1}>HOUSEHOLD MEMBERS</Text>
                            <View style={styles.box}>
                                <View>
                                    <View style={styles.box1}>
                                        <Text style={styles.memberTitle}>Member 1</Text>
                                        <Text style={styles.title}>I. Personal Information</Text>
                                        <View style={styles.inputContainer}>
                                            <Text>Last Name <Text style={styles.required}>*</Text> </Text>
                                            <TextInput
                                                style={styles.input}
                                                value={householdMembers[0].lastName}
                                                onChangeText={(text) => handleInputChange(0, 'lastName', text)}
                                            />
                                        </View>
                                        ...
                                        <View style={styles.inputContainer}>
                                            ...
                                            <TextInput
                                                style={styles.input}
                                                value={householdMembers[0].firstName}
                                                onChangeText={(text) => handleInputChange(0, 'firstName', text)}
                                            />
                                        </View>
                                    ...
                                    {householdMembers.slice(1).map((member, index) => (
                                        <View key={index + 1} style={styles.memberContainer}>
                                            <View style={styles.box1}>
                                                ...
                                                <View style={styles.inputContainer}>
                                                    ...
                                                    <TextInput
                                                        ...
                                                        onChangeText={(text) => handleInputChange(index + 1, 'lastName', text)}
                                                    />
                                                </View>
                                                <View style={styles.inputContainer}>
                                                    ...
                                                    <TextInput
                                                        ...
                                                        onChangeText={(text) => handleInputChange(index + 1, 'firstName', text)}
                                                    />
                                                </View>
                                                <View style={styles.inputContainer}>
                                                    <Text>Middle Name: <Text style={styles.required}>*</Text> </Text>
                                                ...
                                                <View style={styles.inputContainer}>
                                                    {sex === 'Female' && numericAge >= 15 && (
                                                        ...
                                                        <Button title="Add Household Member" onPress={addMember} />
                                                    </View>
                                                </View>
                                            </>
                                        )}
