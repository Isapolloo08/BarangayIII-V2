...
export default function CaseReportDetails({ route }) {
  ...
  const handleAccept = () => {
    Alert.alert(
      "Confirmation",  // Title of the first alert
      "Are you sure you want to accept this report?",  // Message
      [
        {
        ...
        },
        {
          ...
          onPress: () => {
            console.log("Accepted!");  // First action when accepted
  
            // Show a second alert confirming the acceptance
            Alert.alert(
              "Report Accepted",  // Title of the second alert
              "The report has been successfully accepted.",  // Message
              [
                {
                  text: "OK",  // Button for the second alert
                  onPress: () => console.log("Report accepted and alert closed"),  // Action when closed
                },
              ]
            );
          },
      ...
      { cancelable: false }  // Option to make the alert non-dismissible by tapping outside
    );
  };
