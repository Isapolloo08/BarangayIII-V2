...
const ProposeEvent = ({ navigation }) => {
  ...
  const [reminder, setReminder] = useState(allDay ? '8:00 am' : '5 minutes before');
  ...
  const handleReminderSelect = (selectedReminder) => {
  ...
  const handleNextPress = () => {
    if (!eventName.trim() || !location.trim()) {
      ...
      navigation.navigate('EventMaterial', {
        eventName,
        location,
        ...
        <View style={styles.topContainer}>
          <View style={styles.stepIndicator}>
            <View style={styles.stepContainer}>
              <Text style={styles.stepLabel}>Event</Text>
            ...
            <Switch
              ...
              onValueChange={(value) => {
                ...
                if (value) {
                  ...
                  setReminder('8:00 am'); // Set reminder to default 8:00 am when toggling to all-day
                } else {
                  setReminder('5 minutes before'); // Set reminder to default 5 minutes before when toggling to specific time
                }
              }}
